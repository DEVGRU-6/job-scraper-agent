...
# Adzuna Country Codes: Expanded to include all available EU hubs + Australia + Singapore
# (Note: Adzuna does not support UAE, QA, CN, TH, JP, or HK)
TARGET_COUNTRIES = ["gb", "de", "nl", "be", "fr", "es", "it", "at", "ch", "pl", "au", "sg"] 

# 🛑 THE BLACKLIST: Aggressively expanded to remove mid-career and technical/repair roles
EXCLUDED_TERMS = [
    ...
    "senior", "machinist", "cnc", "repair", "tool maker", "toolmaker"
]
